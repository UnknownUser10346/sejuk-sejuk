      ...
      <div className="p-5 flex-1 overflow-auto">
        ...
        <div className="mb-4">
          <button
            ...
            className="bg-[#0e7fa8] text-white text-xs px-3 py-2 rounded-lg hover:bg-[#0c6d92] mt-2"
          >
            + New Order
          </button>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[640px]">
              ...
              <tbody>
                {loading ? (
                  <tr><td colSpan={6} className="text-center text-gray-400 py-10 text-xs">Loading orders...</td></tr>
                ) : filtered.length === 0 ? (
                  <tr><td colSpan={6} className="text-center text-gray-400 py-10 text-xs">No orders found</td></tr>
                ) : (
                  filtered.map(order => (
                    <tr
                      key={order.id}
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-xs text-gray-600 capitalize">{serviceLabel[order.service_type] || order.service_type}</td>
