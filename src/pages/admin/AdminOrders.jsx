            ...
            <table className="w-full min-w-[700px]">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  <th className="text-left text-xs text-gray-400 font-medium px-4 py-2 uppercase tracking-wide w-16">Edit</th>
                    ...
                    <tr key={order.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3">
                        <button
                          ...
                          className="flex items-center gap-1 text-xs text-[#0e7fa8] border border-[#0e7fa8] px-2 py-1 rounded-lg hover:bg-[#0e7fa8] hover:text-white transition-colors"
                        >
